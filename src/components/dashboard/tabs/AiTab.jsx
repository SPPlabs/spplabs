          ...
          <div>
            <h4 className="text-lg font-black text-slate-950 flex items-center gap-2">
              ...
              {renderInfoTooltip && renderInfoTooltip(
                ...
                lang === "es"
                  ? "Los tokens son las unidades básicas que utiliza la inteligencia artificial para procesar y generar texto (1 token equivale aprox. a 4 caracteres o 0.75 palabras). Los tokens de Entrada (Prompt) corresponden a las preguntas de los visitantes e instrucciones del asistente, mientras que los de Salida (Completion) son las respuestas generadas por la IA."
                  : "Tokens are the basic units used by artificial intelligence to process and generate text (1 token ≈ 4 characters or 0.75 words). Input tokens (Prompt) represent visitor questions and system context, while Output tokens (Completion) are the answers generated by the chatbot.",
                "shift-right-mobile"
              )}
            </h4>
